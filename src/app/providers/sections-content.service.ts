...
const SectionsDetails = [//TODO: Change the color property accordingly
  ...
  {"id": 2, "url": "http://www.peleghila.com/", "imgID": "2", "title": "Title Of Section 2", "subTitle": "Section 2 Content - can be very long, so long will need to take a lot of place here, but it's a temporary solution, until server and database are ready"},
