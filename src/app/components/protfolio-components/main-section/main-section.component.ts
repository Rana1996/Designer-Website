...
export class MainSectionComponent implements OnInit {
  ...
  ngOnInit(): void {
    if(this.isFirst){
      ...
      this.description = "Product design leader with theoretical knowledge about psycho-cognitive models and theories.Passionate for creating the product’s lifecycle from research through prototyping to design & usability testing.";
      ...
      this.description = "Can I help with anything?";
